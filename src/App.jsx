...
export default function App() {
  ...
  if (screen === SCREENS.STAFF) return <StaffConcierge onBack={() => setScreen(SCREENS.HOME)} />
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%', maxWidth: 360 }}>
        ...
        <MenuCard emoji="👥" title="Soy del equipo" subtitle="Concierge IA interno · Dashboard operativo" light color="var(--color-text)" onClick={() => onSelect(SCREENS.STAFF)} />
      ...
      <div style={{ fontSize: '0.7rem', color: 'var(--color-text-light)', letterSpacing: '0.1em' }}>
        v1.1.0 · Gestionado por SOLARA Homes
      </div>
    </div>
  )
}
